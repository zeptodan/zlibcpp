...
static void BM_zstl_atomic_stack(benchmark::State& state){
    static atomic_stack<int> stack;
...
BENCHMARK(BM_zstl_atomic_stack)->Range(8, 8 << 18)->Threads(1)->Threads(2)->Threads(4)->Threads(8)->Threads(16);
